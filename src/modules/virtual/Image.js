...
class VirtualImage extends VirtualModule {
  ...
  apply (compiler) {
    ...
    compiler.hooks.normalModuleFactory.tap('VirtualImagePlugin', (nmf) => {
      nmf.hooks.beforeResolve.tapPromise('ResolveVirtualFile', (request) => {
        if (
          request.request.indexOf('.jpg') != -1 && request.request.indexOf('storage') != -1 && request.request.indexOf('file-loader') == -1
        ) {
          ...
          return requestImage(srcUrl).then((buffer) => {
            ...
            // this.writeModule('src/assets/storage/styles/GPWork/5c068cbb383333788a00003d/75808dfd51d049549e5487fe5c0982ef_1600x904_90_1543932979_fitToWidth_adb115059e28d960fa8badfac5516667.jpg', buffer);
            // request.request = 'src/assets/storage/styles/GPWork/5c068cbb383333788a00003d/75808dfd51d049549e5487fe5c0982ef_1600x904_90_1543932979_fitToWidth_adb115059e28d960fa8badfac5516667.jpg';
            return request;
          });
        } else {
